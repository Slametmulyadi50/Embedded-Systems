...
uint8_t broadcastAddress1[] = {0xC8, 0xF0, 0x9E, 0x4E, 0x1D, 0x5C};
uint8_t broadcastAddress2[] = {0x24, 0xD7, 0xEB, 0x15, 0xA7, 0xC4};
uint8_t broadcastAddress3[] = {0x08, 0x3A, 0xF2, 0xB7, 0xC6, 0x80};
